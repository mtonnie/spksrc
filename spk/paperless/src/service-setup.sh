...
CFG_FILE="${SYNOPKG_PKGDEST}/var/paperless.conf"
...
SERVICE_COMMAND="${PAPERLESS_ENV} ${SYNPKG_PKGDEST}/env/python3 ${MANAGE_PY} runserver"
...
service_postinst ()
{
    ...
    #Initialize database
    ${PAPERLESS_ENV} ${SYNOPKG_PKGDEST}/env/bin/python3 ${MANAGE_PY} makemigrations >> ${INST_LOG}
